...
Cagri a Yalcin používají ve své práci \citep{yalcin2008evolving} práci neuronových sítí místo SC a pro nastavení vah používají Evoluční strategie i když je v práci uvádí pod pojemem Getického algoritmu, v naší definici odpovídají ES. Shodují se s Winfieldem a jeho kolegy, že evoluce chování robotického hejna přináší zajímavých strategií, která mohou být mnohem komplexnější než explicitně vytvořené chování. Také však popisují obtížnosti použití Evoluce, zvláště volbu Evolučního algoritmu a efektivnost celého výpočtu. 
\par
