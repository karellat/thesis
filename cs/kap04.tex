...
\redo{Pokud možno přidat spalování paliva}
\subsubsection{Scout robot}
...
\clearpage
	\subsubsection{Vzor popisu podúkolu}
Popis myšlenky podúkolu
\begin{table}[h]\centering   
	\begin{tabular}{l@{\hspace{1.5cm}}D{.}{,}{3.2}D{.}{,}{1.2}D{.}{,}{2.3}}
		\toprule
		\textbf{Nastavení mapy a EA}\\
	...
	\begin{tabular}{l@{\hspace{1.5cm}}D{.}{,}{3.2}D{.}{,}{1.2}D{.}{,}{2.3}}
		...
		\multicolumn{2}{l}{}
	\end{tabular}
	\caption{Vzor - nastavení experimentu}
	\label{tab04:Vzor}
\end{table}
