...
\par
DE se pro tyto účely ukázali jako vhodnější optimalizační nástroj, v rámci prvního experimentu proběhl několik testovacích běhů potvrzující tuto domněnku.\unsure{Budou asi jenom 3 a nevím, jestli komplet stejné jako u Wood Scene, windows na VM se restartoval po update}. 
\par
